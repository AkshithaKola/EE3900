...
V_{C_0}(t)=\frac{2}{3}\brak{ 1+e^{\frac{-3}{2} t}}u(t)
	...
	\begin{figure}[!ht]
			\centering
			\includegraphics[width=\columnwidth]{2.7.png}
...
\solution \begin{figure}[!ht]
			\centering
			\includegraphics[width=\columnwidth]{2.8.png}
			\caption{}
			\label{fig:ngspice}
\end{figure}
...
\begin{enumerate}[label=\arabic*.,ref=\thesection.\theenumi]
\numberwithin{equation}{section}
\item Find $q_2$ in Fig. \ref{fig:qn}.\\
...
\item $v_{C_0}(t)$ = ? Plot using python.\\
		   ...
		   \begin{figure}[!ht]
					   \centering
					   \includegraphics[width=\columnwidth]{3.4.png}
					   \caption{Plot of $V_{C_0}(t)$}
					   %\label{fig:lap-ckt}
		   \end{figure}
           \begin{figure}[!ht]
			\centering
			\includegraphics[width=\columnwidth]{3.5.png}
